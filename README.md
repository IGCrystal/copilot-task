像素级复刻 Copilot Task 展示页面，原网页：https://copilot.microsoft.com/tasks/preview

原本的网页需要登录才能看见，我觉得里面的动画和样式还不错，试过让 AI 复刻还不容易，Gemini 3.1 Pro 都做不到。然后就自己尝试了一下。

复刻后的页面地址：https://3kf1.test.i0c.cc

复刻后的网页只供学习使用，其中的图片和动画都是从原网页上截取的，版权归 微软 及 原作者 所有。
